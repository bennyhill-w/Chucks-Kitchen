    ...
    return (
      <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto w-full px-4 lg:px-6 py-8 flex-1">
          <div className="h-8 w-32 bg-gray-200 rounded-full animate-pulse mb-2" />
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            <div className="flex-1 bg-white rounded-3xl shadow-sm overflow-hidden">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="flex items-center gap-4 px-5 py-5 border-b border-gray-50 last:border-0"
                >
                  ...
                  <div className="h-8 w-24 bg-gray-100 rounded-2xl animate-pulse" />
                </div>
              ))}
            </div>
            <div className="lg:w-96 bg-white rounded-3xl shadow-sm p-6 space-y-4 h-fit">
